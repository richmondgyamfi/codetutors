...
<body class="theme-cyan authentication sidebar-collapse">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="<?php echo URLROOT ?>/public/images/ucclogo1.png"
        ...
        <div class="container">
            <div class="navbar-translate">
                <h6><a class="" href="javascript:void(0);"><img src="<?php echo URLROOT ?>/public/images/ucclogo1.png"
                            width="30" alt="Compass"><span class="m-l-10 text-white">COLLEGE OF DISTANCE EDUCATION
                            COURSE TUTOR'S APPLICATION FORM</span></a></h6>

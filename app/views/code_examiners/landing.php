...
<body data-spy="scroll" data-target=".fixed-top">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge badge-dark badge-pill text-uppercase">
                                    COLLEGE OF DISTANCE EDUCATION, UNIVERSITY OF CAPE COAST</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                PROGRAMME:
                                <span class="badge badge-dark badge-pill text-uppercase">CoDE EXAMINERS
                                    RECRUITMENT</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                DURATION:
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                Applicants must have at least a Master’s Degree with Dissertation, M.Phil. or a Doctoral
                                degree in the subject areas specified below.
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="text-container about white">
                        ...
                        College of Education Studies<br>
                        School of Educational Development and Outreach<br>
                ...
                <div class="col-md-3">
                    <div class="text-container">
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <p class="white">CALL/WHATSAPP US ON 0246337487 OR 0203596072.</p>
                            <p class="white">EMAIL US ON ioe.outreach@ucc.edu.gh.</p>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-md-3">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg white">
                            <li>
                                <a class="white" href="https://topup.ucc.edu.gh/">Apply for Topup Program</a>
                            </li>
                            <li>
  ...
  Launch demo modal
    ...
    <script src="<?php echo URLROOT ?>/public/js/jquery.magnific-popup.js"></script>
    <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo URLROOT ?>/public/js/morphext.min.js"></script>
    <!-- Morphtext rotating text in the header -->
    <script src="<?php echo URLROOT ?>/public/js/isotope.pkgd.min.js"></script> <!-- Isotope for filter -->
    <script src="<?php echo URLROOT ?>/public/js/validator.min.js"></script>

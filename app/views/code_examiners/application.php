                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname"
                                            value="<?=$applicant->fname;?>" required name="fname"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="text-uppercase font-weight-bold" for="mname">Middle Name</label>
                                        <input type="text" class="form-control" value="<?=$applicant->mname;?>"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lname"
                                            value="<?=$applicant->lname;?>" required name="lname"
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="text-uppercase font-weight-bold" for="staffno">Tutors Staff
                                            Number</label>
                                        <input type="text" class="form-control" id="staffno"
                                            value="<?=$_SESSION['staff_no_start'];?>" required name="staffno"
                                            placeholder="Code Staff Number">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="text-uppercase font-weight-bold" for="dob">Date of Birth</label>
                                        <input type="date" class="form-control" value="<?=$applicant->dob;?>" id="dob"
                                            required name="dob" placeholder="Date of Birth">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control"
                                            value="<?=(!empty($applicant->phone)?$applicant->phone:(!empty($applicant->phone_no)?$applicant->phone_no:''));?>"
                                            maxlength="10" id="phone_no" required name="phone_no" placeholder="Phone">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control"
                                            value="<?=(!empty($applicant->email)?$applicant->email:'');?>" id="email"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="ghcard" class="form-control"
                                            value="<?=(!empty($applicant->ghcard_no)?$applicant->ghcard_no:'');?>"
                                            id="ghcard" required name="ghcard" placeholder="Enter Your Ghana Card">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="curr_loc"
                                            value="<?=(!empty($applicant->curr_loc)?$applicant->curr_loc:'');?>"
                                            required name="curr_loc" placeholder="Enter Your Current Location">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?=(!empty($applicant->bankname)?$applicant->bankname:'');?>"
                                            id="bankname" required name="bankname" placeholder="Bank Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?=(!empty($applicant->branch)?$applicant->branch:'');?>" id="branch"
                                            required name="branch" placeholder="Branch Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="text-uppercase font-weight-bold" for="acc_name">Account
                                            Name</label>
                                        <input type="text" class="form-control"
                                            value="<?=(!empty($applicant->acc_name)?$applicant->acc_name:'');?>"
                                            id="acc_name" required name="acc_name" placeholder="Account Name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="text-uppercase font-weight-bold" for="acc_no">Account
                                            Number</label>
                                        <input type="text" class="form-control"
                                            value="<?=(!empty($applicant->acc_no)?$applicant->acc_no:'');?>" id="acc_no"
                                            required name="acc_no" placeholder="Account Number">
                                    </div>
                                </div>
                            </div>
                            <hr><br>
                            <div class="col-sm-12 mt-5 mb-5">
                                <button type="submit" class="btn btn-block btn-round"
                                    style="background-color:#1c2473;">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>

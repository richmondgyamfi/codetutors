                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" maxlength="10" id="phone_no"
                                                    name="phone_no" placeholder="Staff Number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="container">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
                                ...
                                <p><b>INVITATION TO CO-ORDINATION AND CONFERENCE MARKING OF END OF SEMESTER I
                                        EXAMINATION
                                        SCRIPTS (202L/2022)</b></p>
                                <p>You are kindly invited as a Team Leader to participate in the coordination meeting
                                    and
                                    nonresidential conference marking of End-of-Semester I Examinations scripts
                                    (2021/2022)
                                    scheduled for
                                    6th b 13th october, 2022 at the <b><?=$_SESSION['marking_centre'];?></b> Marking
                                    Centre.
                                    Please, you have
                                ...
                                <ul>
                                    <li>Monday, 3rd October,2022 - Arrival of Team Leaders at CoDE, UCC</li>
                                    <li>Tuesday, 4th Octobcr ,2022 - Coordination of feam Leaders by Chief Examiners at
                                        CoDE, UCC
                                    </li>
                                    <li>Wednesday,5th October,2022 - Departure of Team Leaders to Marking Centres </li>
                                    <li>Thursday, 6th October ,2022 - Opening Ceremony and Coordination of Assistant
                                        Examiners by Team Leaders at the marking centres
                                        (8:00 am prompt)</li>
                                    <li>6th - 13th Ocbber,2022 - Marking Period</li>
                                </ul>
                                </p>
                                <p>
                                    <b>Your allowances for the number of scripts marked, meals, vetting, hospitality and
                                        a
                                        maximum
                                        of three (3) round trips (a round trip is from Home-to-Marking Centre-back
                                        to-Home)
                                        will be
                                        paid to your Ilank Account after the marking period.</b> Kindly provide/confirm
                                    your
                                    bank details
                                    ...
                                    ('f & T) allowance.
                                    <br>
                                    We are, by a copy of this letter, requesting your <b>Head of Institution</b> to
                                    grant
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        Provost, CoDE <br>
                                        Ag. College Registrar, CoDE <br>
                                        Ag. College Finance Officer, CoDE <br>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-8 col-lg-8 col-xl-8 col-sm-8">
                            <p>Tel.: 0332-096502 / 03321- 35203 / 36947<br>
                                Fax: 03321- 33655 <br>
                                E-mail: code.examsunit@ucc.edu.gh/cce@ucc.edu.gh / cceucc@yahoo.com </p>
                            <p><b>Our Ref.:</b> CoDE/Exams/E.2/Vol.1/189</p>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xl-4 col-sm-4">
                            <p>UNIVERSITY OF POST OFFICE <br>
                                CAPE COAST</p>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
                            ...
                            <p><b>INVITATION TO CO-ORDINATION AND CONFERENCE MARKING OF END OF SEMESTER I EXAMINATION
                                    SCRIPTS (2021/2022)</b></p>
                            <p>
                                You are kindly invited as an Assistant Examiner to participate in the non-residential
                                conference marking of End of Semester I Examinations scripts (202112022) scheduled for
                                <b>6th to 13th October,
                                    2022</b> the <b><?=$_SESSION['marking_centre'];?></b> Marking Centre. Please, you
                                have been selected to mark <b><?=$_SESSION['course'];?></b>.
                            </p>
                            <b>Please, note the following schedule:</b>
                            <ul>
                                <li>Thursday, 6th October, 2022 - Arrival of Assistant Examiners at the various marking
                                    centres (8:00 am prompt) </li>
                                <li>Thursday, 6th October ,2022 - Opening Ceremony and Coordination of Assistant
                                    Examiners at the marking centres </li>
                                <li>6th - 13th October,2O22 - Marking Period </li>
                            </ul>
                            </p>
                            <p>
